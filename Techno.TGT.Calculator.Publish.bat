...
set BASE_DIR=C:\Users\kevinp\source\repos\TgtClientCalculator\
set DEPLOYMENT_PATH=\\tp-dc-apps01\sandbox

set SITE_DIR=%BASE_DIR%\TGT.OnlineCalculator.Site
set SITE_OUTPUT=%DEPLOYMENT_PATH%\client-calculator
